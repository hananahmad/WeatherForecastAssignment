...
//MARK:- Public Methods
    ...
    @objc func getLocation(completionHandler:@escaping LocationClosure) {
    ...
    @objc func getReverseGeoCodedLocation(location:CLLocation,completionHandler:@escaping ReverseGeoLocationClosure) {
